...
lm_model <- lm(lt_post_tot_reach ~ `Type` + `Page total likes` + I(log_like^2), data = facebook)
...
lm_model <- lm(lt_ppl_lkd_egnged ~ `Type` + `Page total likes` + I(log_like^2), data = facebook)
